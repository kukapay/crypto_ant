...
def call_llm(
    prompt: str,
    model: str = os.getenv("OPENAI_MODEL_ID"), #"gpt-4.1",
  ...
  # Initialize the LLM.
  llm = ChatOpenAI(model=model, temperature=0, api_key=os.getenv("OPENAI_API_KEY"), base_url=os.getenv("OPENAI_BASE_URL"))
